...
export const SnippetCard = ({
  ...
  return (
    ...
    >
      ...
      <div className="p-4">
        <h3 className="font-bold InterRegular text-gray-900">
          {snippet.title}
        </h3>
        <p className="InterRegular text-gray-500 InterRegular text-sm mt-1">
        ...
        <div className="flex justify-between items-center mt-4">
          <div className="flex space-x-4 InterRegular text-gray-400">
            ...
            <button className="flex items-center space-x-1 hover:InterRegular text-purple-600">
              <FiHeart size={14} />
              <span className="InterRegular text-xs">{snippet.likes}</span>
            </button>
          </div>
          <button
            onClick={() => {
